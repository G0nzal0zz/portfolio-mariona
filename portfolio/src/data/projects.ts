export type Project = {
  ...
  image: string | null; // ruta en /public/images/projects/<slug>/, o null si aún no hay foto
...
// Estructura de imágenes: /public/images/projects/<slug>/cover.jpg (+ otras para la página interior).
